...
const TransportationSection: React.FC = () => {
  ...
  return (
    <section className="py-20 bg-gradient-to-br from-blue-50 via-white to-blue-50/50 dark:from-gray-900 dark:via-gray-900 dark:to-gray-800">
        ...
        <div className="grid lg:grid-cols-3 gap-8">
          {transportationMethods.map((method, index) => (
            ...
            >
              ...
              <div className="absolute -bottom-2 -right-2 w-24 h-24 bg-gradient-to-br from-blue-400 to-blue-600 rounded-full opacity-0 group-hover:opacity-10 transition-opacity duration-500 blur-xl"></div>
            </div>
          ))}
        </div>
