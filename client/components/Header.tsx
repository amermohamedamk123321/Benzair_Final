        ...
        <div className="container mx-auto px-4">
          ...
          <div className="md:hidden">
            ...
            <div
              ...
              className={`fixed inset-0 bg-black/30 backdrop-blur-sm transition-opacity duration-300 z-30 ${isMenuOpen ? 'opacity-100 pointer-events-auto' : 'opacity-0 pointer-events-none'}`}
            ...
            <div
              ...
              className={`fixed left-0 right-0 top-[68px] z-40 transform origin-top transition-all duration-300 ease-in-out bg-white dark:bg-slate-900 border-t dark:border-slate-800 ${
                isMenuOpen ? 'scale-y-100 opacity-100 pointer-events-auto' : 'scale-y-95 opacity-0 pointer-events-none'
              }`}
              style={{ transformOrigin: dir === 'rtl' ? 'top right' : 'top left' }}
            >
              <div className="py-4">
                <nav className="flex flex-col space-y-2 px-2">
                  ...
                  <div className="mx-1 mt-4 flex justify-center">
                    <DarkModeToggle />
                  </div>
                  ...
                  <Link
                    ...
                    onClick={() => setIsMenuOpen(false)}
                    aria-label="Open admin dashboard"
                    className="mx-1 mt-4 px-5 py-3 bg-blue-900 text-white text-sm font-semibold rounded-full hover:bg-blue-800 transition w-fit self-center"
                  >
